...
export default function Hero() {
  return (
    <section className="hero">
      ...
      <svg aria-hidden="true" className="paw-deco" style={{ top: 40, left: -40, width: 160, color: 'var(--blue)' }} viewBox="0 0 24 24" fill="currentColor"><circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><circle cx="7" cy="9" r="2"/><path d="M16.5 15.5c-1.5-1.5-3-3-4.5-3s-3 1.5-4.5 3-3 3-3 5 1.5 3 3.5 3 3-1 4-1 2 1 4 1 3.5-1 3.5-3-1.5-3.5-3-5z"/></svg>
      <svg aria-hidden="true" className="paw-deco" style={{ bottom: 20, right: 40, width: 120, color: 'var(--orange)', transform: 'rotate(35deg)' }} viewBox="0 0 24 24" fill="currentColor"><circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><circle cx="7" cy="9" r="2"/><path d="M16.5 15.5c-1.5-1.5-3-3-4.5-3s-3 1.5-4.5 3-3 3-3 5 1.5 3 3.5 3 3-1 4-1 2 1 4 1 3.5-1 3.5-3-1.5-3.5-3-5z"/></svg>
...
<h1>
          ...
          <p className="hero-sub">
            Clínica veterinária, banho e tosa, vacinação e delivery de ração, tudo em um só lugar.
          </p>
